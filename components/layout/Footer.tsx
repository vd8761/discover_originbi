...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="w-full bg-[#19211c] relative z-40">
      
      {/* ===== TOP SECTION (Dark Background, Quick Links, Contacts) ===== */}
      <div className="w-full py-20 px-6 lg:px-10 2xl:px-[clamp(24px,2.5vw,48px)] border-t border-white/5 relative overflow-hidden">
