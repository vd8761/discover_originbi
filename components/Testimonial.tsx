...
const Testimonial: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-full bg-brand-dark-secondary rounded-[16px] overflow-hidden p-6 md:p-8 lg:p-[5%] flex flex-col justify-end min-h-[450px] lg:min-h-full">
      ...
      <div key={currentIndex} className="relative z-20 flex flex-col justify-end h-full mt-24">
          ...
          <div className="flex items-end justify-between gap-4">
            ...
            <div className="flex gap-3 shrink-0">
              <button
                ...
                className={`rounded-full p-[clamp(8px,0.6vw,12px)] transition-all transform hover:scale-105 cursor-pointer ${
                  currentIndex === 0
